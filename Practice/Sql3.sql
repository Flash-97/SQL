...
사번(employee_id), 이름(first_name)과 채용일(hire_date), 매니저이름(first_name), 매니저입사일
(hire_date)을 조회하세요.
(37건)*/
...
and de.manager_id = em.manager_id
...
select em.employee_id,
       ...
       de.department_name,
       emp.employee_id 
from employees em, departments de, employees emp
where em.department_id = de.department_id(+)
and em.manager_id = emp.employee_id;
